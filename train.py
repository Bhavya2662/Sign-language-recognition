...
classifier.fit(training_set, epochs=5, validation_steps=4268, steps_per_epoch=12841, callbacks=[reduce_lr, early_stop], validation_data=test_set)
...
print(accuracy_score(training_set,classifier.predict(test_set)))
# Saving the model
